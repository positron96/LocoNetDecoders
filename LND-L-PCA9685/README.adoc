...
////
The firmware had an way to configure some parameters via throttle commands without the need for a PC and UART.
This is removed now, but may be implemented again in future.
